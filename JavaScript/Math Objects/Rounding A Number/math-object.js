...
// // Math.round - rounds a number to the nearest integer (Example 2)
console.log("Math.round() --------");
console.log("Math.round(4.6)", Math.round(4.6));
console.log("Math.round(4.3)", Math.round(4.3));

// // Math.floor - Rounds down to the nearest down integer (Example 2)
...
//Math.max and Math.min find the largest / smallest numner
